...
import '../edit_ride_2/edit_ride2_widget.dart';
...
class EditRide1Widget extends StatefulWidget {
  const EditRide1Widget({
    Key? key,
    this.propertyRef,
  }) : super(key: key);
  ...
  @override
  _EditRide1WidgetState createState() => _EditRide1WidgetState();
}

class _EditRide1WidgetState extends State<EditRide1Widget> {
  TextEditingController? propertyAddressController;
  TextEditingController? rideNameController;
  ...
  void initState() {
    ...
    propertyAddressController =
        TextEditingController(text: widget.propertyRef!.rideAddress);
    rideNameController =
        TextEditingController(text: widget.propertyRef!.rideName);
    propertyDescriptionController =
        TextEditingController(text: widget.propertyRef!.rideDescription);
  }
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              await Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => EditRide2Widget(
                                    propertyRef: widget.propertyRef,
