...
class EditRide3Widget extends StatefulWidget {
  const EditRide3Widget({
    Key? key,
    this.propertyRef,
  }) : super(key: key);
  ...
  @override
  _EditRide3WidgetState createState() => _EditRide3WidgetState();
}

class _EditRide3WidgetState extends State<EditRide3Widget> {
